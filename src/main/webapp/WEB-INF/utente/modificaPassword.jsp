...
<html>
    ...
    <body>
        ...
        <main id="result">
            ...
            <%}%>
            <form action="modifica-password" onsubmit="return validateFormCambiaPassword()" method="post">
                <label for="oldPassword">Vecchia password:</label>
                <input type="password" id="oldPassword" name="old-password" required>
                <label for="newPassword1">Nuova password:</label>
                <input onkeyup="validatePassword('newPassword1')"  onkeyup="activeOtherPassword()" type="password" id="newPassword1" name="new-password-1" required>
                ...
                <input type="password" id="newPassword2" name="new-password-2" onkeyup="validateEqualsPassword()" disabled required>
