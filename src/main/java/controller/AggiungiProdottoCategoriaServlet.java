...
@WebServlet(name = "AggiungiProdottoCategoriaServlet", value = "/aggiungi-categoria-prodotto")
public class AggiungiProdottoCategoriaServlet extends HttpServlet {
    @Override
                    ...
                    if(idCategoriaString != null){
                        try{
                            ...
                            if(categoria != null){
                                ...
                                if(prodottiDaRimuovere.stream().noneMatch(p->categoria.getProdotti().contains(p))){
                                    for(Prodotto prodotto : prodottiDaRimuovere){
                                        categoriaDAO.doSaveProdottoCategoria(categoria, prodotto);
                                    }
